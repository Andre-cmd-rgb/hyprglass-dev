...
- Hyprpaper reads `~/.config/hypr/hyprpaper.conf`. To avoid startup path issues, the installer and Settings wallpaper repair write absolute wallpaper paths into the installed config.
